...
local banCommand = {
	...
	onRun  = function(self,ply,args)
		...
		local user = g.FindPlayer(findUser)
...
-- g.chat.commands
g.chat.RegisterCommand("/ban",banCommand)
...
g.chat.RegisterCommand("/givexp",giveXPCommand)
...
g.chat.RegisterCommand("/setusergroup",SetUserGroupCommand)