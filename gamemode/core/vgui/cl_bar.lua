...
function PANEL:SetupBar(Label,Time)
  self.Tween = tween.new(Time, self.TweenProg, {["Progress"] = 1}, "linear")
...
function PANEL:Paint(w,h)
  ...
  surface.DrawRect(0,0,w*(self.TweenProg.Progress),h)
  surface.SetDrawColor(40,40,40,255)
  surface.DrawOutlinedRect(0,0,w,h,2)
  landis.DrawText(tostring(floor(self.TweenProg.Progress*100)).."%",w/2,h/2,{size=24,bold=true,shadow=true},{x=TEXT_ALIGN_CENTER,y=TEXT_ALIGN_CENTER},color_white)
  ...
  if self.TweenProg.Progress == 1 then
