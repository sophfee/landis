-- Outline Module taken from Garry's Mod Pull Request #1590 - https://github.com/Facepunch/garrysmod/pull/1590
-- All entirely created by: https://github.com/ShadowBonnieRUS, all credit for this goes to them.
-- I (urnotnick) converted this to work as a normal include
